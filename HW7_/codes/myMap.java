...
public class myMap {
   ...
   /**
    * using selection sort create new map
    */
   public void sortlistbyselection()
   {
        Selectionsort selection=new Selectionsort(this, aux);
        // System.out.println("Flag1");
        selection.sortthemap();
   }

   /**
    * using selection sort create new map
    */
   public void sortlistbyinsertion()
   {
        InsertionSort insertion=new InsertionSort(this, aux);
        // System.out.println("Flag1");
        insertion.sortthemap();
   }

   /**
    * using selection sort create new map
    */
   public void sortlistbybubble()
   {
        Bubblesort buble=new Bubblesort(this, aux);
        // System.out.println("Flag1");
        buble.sortthemap();
   }
    ...
    * using selection sort create new map
    */
   public void sortlistbyquick()
   {
        Quicksort quick=new Quicksort(this, aux);
        // System.out.println("Flag1");
        quick.sortthemap();
   }
}
