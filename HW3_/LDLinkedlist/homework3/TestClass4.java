...
public class TestClass4 {
    ...
    {
        // Account[] all_account=new Account[100];
        // int counter=0;
        // for(int i=0;i<100;i++)
        // {
        ...
        // System.out.println( "\n\ntested element number equals 100:"+"\u001B[32m"+totalTime_lazy/1e9+"\u001B[0m\n\n");
        ...
        account2.add_outboux(account1, new Message("gizemsungu", "sibelgulmez","where are you", 0));
